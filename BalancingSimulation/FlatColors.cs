...
namespace BalancingSimulation
{
    public static class FlatColors
    {
        ...
        public static Color Red3 = ColorTranslator.FromHtml("#FF6239");
        public static Color Red4 = ColorTranslator.FromHtml("#FF7A23");
        ...
        public static Color GrayLight2 = ColorTranslator.FromHtml("#dcdcdc");
